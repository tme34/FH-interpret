...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      h6("FH-Interpret (v1.5) is developed and maintained by Helene Gellert-Kristensen, Tim Møller Eyrich og Stefan Stender from the Department of Clinical Biochemistry at Rigshospitalet, Denmark. Contact: stefan.stender@regionh.dk")
      ),
      
      nav_panel("Documentation", 
                h5("FH-Interpret (v1.5) provides data for classifying variants in the LDLR, APOB, and PCSK9 genes. For the selected variant, the app generates a draft interpretation text. The app describes the available evidence but does not make suggestions for the final classification. The following data is included:"),
                ...
                h4(HTML("Global Lipids Genetics Consortium (GLGC) exome chip GWAS meta-analysis from 2017 (PMID: <a href='https://pubmed.ncbi.nlm.nih.gov/29083408/' target='_blank'>29083408</a>):")),
